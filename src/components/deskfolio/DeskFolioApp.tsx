...
function EditableNameTag({ className = '' }: { className?: string }) {
  ...
  useEffect(() => {
    const el = ref.current
    if (el && !el.textContent) el.textContent = 'Masykur'
  }, [])
...
const DESKFOLIO_WARM_SRCS: string[] = [
  ...
  '/profile.webp?v=3', // about-page avatar
]
...
const DEFAULT_DEV_ACTIVITY_LINK = 'https://github.com/Masykster'
        ...
        <span className="df-ipad-screen">
          ...
          <svg className="df-ipad-ui" viewBox="0 0 264 201" preserveAspectRatio="xMidYMid meet" aria-hidden="true">
            ...
            <g className="df-ui-tags">
              ...
              <text x="36" y="192.6">Astro</text><rect x="61" y="182" width="29" height="15" rx="7.5" /><text x="75.5" y="192.6">React</text><rect x="95" y="182" width="47" height="15" rx="7.5" /><text x="118.5" y="192.6">Laravel</text>
            </g>
          </svg>
        </span>
      </span>
...
const IconGlobe = (p: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" {...p}>
    <path d="M12 0c-6.627 0-12 5.373-12 12s5.373 12 12 12 12-5.373 12-12-5.373-12-12-12zm1 16.947v1.989c0 .59-.395 1.064-.993 1.064-.596 0-.993-.475-.993-1.064v-1.996c-2.484-.287-4.606-1.579-5.748-3.488-.238-.396-.118-.911.272-1.155.394-.241.905-.122 1.147.273.876 1.449 2.502 2.441 4.329 2.64v-3.71c-2.316-.367-4.577-1.341-4.577-3.877 0-1.895 1.309-3.238 3.197-3.659-.015-.098-.03-.197-.042-.298-.098-.823.504-1.564 1.334-1.644.821-.08 1.558.508 1.637 1.33.011.092.019.184.025.275 2.148.455 3.593 1.944 3.593 3.996 0 2.55-2.261 3.524-4.577 3.891v3.69c1.834-.196 3.465-1.189 4.341-2.641.242-.396.753-.516 1.147-.273.393.242.513.758.271 1.154-1.139 1.908-3.255 3.203-5.736 3.493z"/>
  </svg>
)
  ...
  <div className="df-cover">
    ...
    <div className="df-cover-label">
      <span className="df-cover-mark" aria-hidden="true">
        <span className="df-cover-mono">AM</span>
        <svg className="df-cover-cursor" viewBox="0 0 24 24" fill="currentColor">
          <path d="M4.037 4.688a.495.495 0 0 1 .651-.651l16 6.5a.5.5 0 0 1-.063.947l-6.124 1.58a2 2 0 0 0-1.438 1.435l-1.579 6.126a.5.5 0 0 1-.947.063z" />
        </svg>
      </span>
      <p className="df-cover-title">Abdullah Masykur</p>
      <span className="df-cover-sub">Software Engineer &amp; Web Dev</span>
...
const PORTFOLIO_PAGES: React.ReactNode[] = [
  ...
  <div className="df-page" key="p0">
    ...
    <div className="df-about-head">
      <span className="df-avatar"><img src="/profile.webp?v=3" alt="Abdullah Masykur" loading="lazy" decoding="async" /></span>
      <div>
    ...
    <div className="df-card">
      <Editable
        ...
        initial="Mahasiswa D4 Manajemen Informatika UNESA (IPK 3.93). Berfokus pada modern web application, frontend engineering (Astro, React, Next.js, Tailwind), backend Laravel, serta UI interaktif yang hidup."
      />
    </div>
    <p className="df-label df-label--push">currently…</p>
    <span className="df-date"><LbHeart /> open to internship &amp; collabs</span>
  </div>,
  ...
  <div className="df-page" key="p1">
    ...
    <div className="df-card df-card--lilac">
      ...
      <ul className="df-tags">
        <li className="df-tag">Astro</li>
        <li className="df-tag">React</li>
        <li className="df-tag">TypeScript</li>
        <li className="df-tag">Tailwind CSS</li>
        <li className="df-tag">Laravel</li>
        <li className="df-tag">Next.js</li>
        <li className="df-tag">Flutter</li>
    ...
    <div className="df-card">
      ...
      <ul className="df-tags df-tags--blush">
        <li className="df-tag">Clean Architecture</li>
        <li className="df-tag">Responsive UI</li>
        <li className="df-tag">Micro-interactions</li>
        <li className="df-tag">UI/UX &amp; Accessibility</li>
      </ul>
    </div>
  </div>,
  ...
  <div className="df-page" key="p2">
    ...
    <div className="df-proj">
      <p className="df-proj-head"><DfProjName href="https://github.com/Masykster/angonku-id" variant={0}>Angonku.id</DfProjName><span className="df-proj-meta">livestock tech</span></p>
      <Editable className="df-edit--body df-proj-desc" placeholder="describe it…" initial="Platform manajemen peternakan ayam broiler digital dengan FCR, IP score real-time, dan laporan PDF bankable." />
    </div>
    <div className="df-proj">
      <p className="df-proj-head"><DfProjName href="https://github.com/Masykster/CuanLagi-AI" variant={2}>CuanLagi-AI</DfProjName><span className="df-proj-meta">fintech &amp; AI</span></p>
      <Editable className="df-edit--body df-proj-desc" placeholder="describe it…" initial="Platform asisten finansial pintar berbasis AI untuk analisis keuangan, pencatatan otomatis, dan optimasi cuan." />
    </div>
  </div>,
  ...
  <div className="df-page" key="p3">
    ...
    <div className="df-proj">
      <p className="df-proj-head"><DfProjName href="https://github.com/Masykster/EcoFlow" variant={3}>EcoFlow</DfProjName><span className="df-proj-meta">sustainability</span></p>
      <Editable className="df-edit--body df-proj-desc" placeholder="describe it…" initial="Aplikasi web sustainability dengan REST API terdokumentasi dan CI/CD pipeline GitHub Actions." />
    </div>
    <div className="df-proj">
      <p className="df-proj-head"><DfProjName href="https://github.com/Masykster/DailyBit" variant={1}>DailyBit</DfProjName><span className="df-proj-meta">habit tracker</span></p>
      <Editable className="df-edit--body df-proj-desc" placeholder="describe it…" initial="Gamified habit tracker dan daily journaling mobile app dengan streak dan cloud sync real-time." />
    </div>
    <p className="df-sig">…dan projek lainnya di GitHub <span className="df-heart" aria-hidden="true">♡</span></p>
  </div>,
  // spread 3 left: experience timeline
  <div className="df-page" key="p4">
    <h3 className="df-hello">experience &amp; edu</h3>
    <ul className="df-xp">
      <li className="df-xp-row">
        <span className="df-xp-dot" aria-hidden="true" />
        <div>
          <p className="df-xp-role">Web Developer Intern</p>
          <p className="df-xp-meta">Ascendemy · 2026 until Now</p>
        </div>
      </li>
      <li className="df-xp-row">
        <span className="df-xp-dot" aria-hidden="true" />
        <div>
          <p className="df-xp-role">D4 Manajemen Informatika</p>
          <p className="df-xp-meta">Universitas Negeri Surabaya · 2024 to Now (IPK 3.93)</p>
        </div>
      </li>
      <li className="df-xp-row">
        <span className="df-xp-dot" aria-hidden="true" />
        <div>
          <p className="df-xp-role">Ilmu Pengetahuan Alam (IPA)</p>
          <p className="df-xp-meta">SMA Negeri 13 Surabaya · 2021 to 2024</p>
        </div>
      </li>
    </ul>
  </div>,
  ...
  <div className="df-page" key="p5">
    ...
    <Editable
      ...
      initial="Tertarik berkolaborasi atau ingin mendiskusikan peluang proyek baru? Jangan ragu untuk terhubung langsung!"
    />
    <ul className="df-links">
      <li>
        <a className="df-link" href="https://github.com/Masykster" target="_blank" rel="noreferrer"><IconGitHub /> GitHub</a>
      </li>
      <li>
        <a className="df-link" href="https://www.linkedin.com/in/abdullah-masykur" target="_blank" rel="noreferrer"><IconLinkedIn /> LinkedIn</a>
      </li>
      <li>
        <a className="df-link" href="mailto:masykur6060@gmail.com" target="_blank" rel="noreferrer"><IconMail /> Email</a>
      </li>
      <li>
        <a className="df-link" href="https://masykster.is-a.dev/" target="_blank" rel="noreferrer"><IconGlobe /> Website</a>
      </li>
    </ul>
  ...
  <div className="df-page" key="p6">
    ...
    <h3 className="df-hello">made with passion</h3>
    <div className="df-card">
      <Editable
        className="df-edit--body"
        placeholder="a little note…"
        initial="Website portofolio ini dibangun dengan Astro, React, dan Motion. Memiliki simulasi fisika lembaran buku 3D, stiker meja yang dapat diatur, coretan marker otomatis, dan haptic feedback."
      />
    </div>
    <p className="df-sig">karya Abdullah Masykur <span className="df-heart" aria-hidden="true">♡</span></p>
  </div>,
  ...
  <div className="df-page df-thanks" key="p7">
    ...
    <span className="df-thanks-sub">let's build something awesome</span>
  </div>,
]
